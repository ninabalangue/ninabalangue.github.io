              ...
              {EDUCATION_DATA.map((edu, idx) => (
                ...
                >
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {edu.latinHonor && (
                      <span className="inline-flex items-center gap-1 text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-amber-50 border border-amber-300 text-amber-800 shadow-2xs">
